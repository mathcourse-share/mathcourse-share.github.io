...
**how-to-learn&solve-question The Science Way**

本文受到 Eric S. Raymond, Rick Moen 的 "How to ask" 启发，结合自己的心得以及自己和别人学习的经历写出，感谢 Eric S. Raymond, Rick Moen 的优秀的文章


Eric S. Raymond, Rick Moen的原文网址：[http://www.catb.org/~esr/faqs/smart-questions.html](http://www.catb.org/~esr/faqs/smart-questions.html)
...
本指南将试图教会你如何学习(数学)和正确地提问以获得你满意的答案。适合渴望学习但不得法或者学习方法上有问题的学生

---

首先是如何学习，学习是一件非常重要的事情，因为学习在这个时代是常用的能力，关系到能力的养成，考试能否通过等等。一般来说学习（以数学为例），你需要先熟悉教材，也就是看下这本书大致讲了哪些东西，然后是预习，在预习的时候你要列出你不太理解东西如果记不得最好写下来，然后是听课，听课的过程中尝试解决你在预习时候遇到的问题,并不断提出新的问题,以及再次尝试解决.在学习的时候一定要有笔记,笔记不必手写,它记载着你的心得体会,最重要的是它能在你回头的时候给你一个记录.一个知识点学完以后需要反思,整理错题,完善笔记,最终形成自己的知识体系.当然在这个过程中你需要不断地试错才能成功.

稍微总结一下,大致需要完成:`预习` $→$ `听课` $→$ `反思复习等其他形式` $→$ `形成自己知识体系`

详细解释在下面
---
接下来是提问

现在这个时代是一个互联时代，我们有发达的互联网和移动互联网，我们所需要做的事情是学会搜索和提问以及总结不断思考，来解决我们的问题。相信我大部分老师对学生非常宽容，即便你问了他上课才刚刚讲过的问题，他也不会非常生气（可能会责备你没有好好听课），但我相信看过本文以后，你能掌握提问的技巧，让双方都能得到好的体验。


### 学习-预习

首先,当你从未接触过接下来所学习的内容时,你应该自己寻找一份适合自己水平的教材或者资料来进行主要学习也就是精读(当然咱们最主要的就是用课本,不过我还是推荐可以看看其他国家或地区的教材,比如美国法国的,新加坡的等),选择讲法难度不同的书进行泛读,对于数学课来说,一定要在学习完之后可以取自己做一下习题从易到难,把自己第一次不会的题目记录下来,在听课了之后再自己回顾一遍.这是主教材,其他的内容你可以自己选择,比如更难的题目,更高级的内容等,这些可以自己根据自己情况选择

### 听课(新课)
比如学习你现在的章节时候(以单变量微积分为例),你可以先划分内容段落,标记难点部分(如果问题太难,可以把大问题分解成若干个小问题),然后再思考,最好记在笔记上,标记清楚(你知道这是你预习时候的问题就行),等到课上听课的时候,你要关注这些问题,如果老师没提到或者解释你不满意你可以等老师有空的时候再去问.听课的笔记最好只记要点,不要满满当当记一大页,或者拍照,相信我这样很多人没有时间课下再去重做笔记.听课的笔记应当是记录下课程的完整脉络,以及回答预习时的问题和提出新的问题,最好课后进行复盘,整理笔记.这样才能在你还记得的时候巩固

### 笔记
其实这一节在之前又讲,我再完整讲一遍.

我们`预习`,`听课`,`反思复习归纳总结`时候都要记得适当记录笔记,为什么记笔记,当然是对你无法记得的事情的记录防止遗忘,最后让我们把这些东西记在心里,形成自己的知识体系,最终达到把笔记越记越薄的效果.

`预习笔记`,`听课笔记`,`课后笔记`


注意几个点:
1. 可读性: 你的笔迹是要自己回看的,所以不要太简略,一定要自己能看懂(不要写个比如你记笔记"今天是最开心的一天"然后过几天再看发现不记得为啥开心了)
2. 留白(康奈尔笔记法),比如一个A5的本子,你把错题写右半边,左边过两天一个星期再回来看等等
3. 最好手写!!!
4. 自己能理解,比如可以用不同颜色的笔来写加深理解

### 做题(练习)
大致分为
1. `轻度动脑题`: 包括概念的理解,定理的应用,定理的扩展(比如逆命题,否命题,或者条件减弱时是否仍然成立),补充知识(某些二级结论),这些往往是做完以后就成为你的知识体系的重要节点

2. `体力题`: 包括一些需要刻意练习的题目,肌肉记忆,尽量做到像呼吸一样自然,熟练以后就适可而止

3. `应试`: 比如中高考、考研、竞赛(大数,丘成桐,阿里巴巴等)等

顺便说下,一个数学题,应该是先在草稿纸上写清楚过程,然后再写到笔记或者试卷上

### 反思*
学习很多东西最重要的是构建自己的知识体系,,前面的东西都是理解知识点,到这一步的时候往往你已经前面学完了,现在你可能处在准备期末考试或者学习下一节的过程中,那么在这个时候你前面学的东西就像积木块,预制件之类的东西,在这个时候我们把它们按照某种"规则"拼起来就好. 它可能是一个"树",一个房子或是其他现实生活中没有的

比如你可以再回头看一遍教材笔记等等,回看老师上课录像,整理错题(你可以把你自己的整理在笔记上的错题,拼成一个卷子自己做做)

### 交流
和你的老师同学或是其他人多交流,要尽量和不同水平的人交流.(男生女生宿舍同伴效应),很多时候你和低水平的学生或者同水平的学生交流某个问题的时候你也是在重新学习(费曼学习法),和高水平的人交流(请教别人问题时候你只要请教之前认真思考,别人不会瞧不起你,而且可能别人水平没你好)
...
首先你要知道，大多数被提问者喜欢你的问题是经过你思考的，或是有挑战的问题，当然，请不要拿未经思考的问题和远超你学习水平的题目去提问（比如你拿奥赛题去提问你的数学老师），如果你听到了你的老师，说“这个问题问的好”或之类的话，说明他仍可你的提问，而如果你提出的问题是在你的正常发展水平上，并且是他/她所忽视的，那有可能你的问题会进入到他/她的教案中，因为这个问题能代表你这个水平的学生。一个好的值得玩味和思考的问题就像一个路灯，能让你深深烙印这个问题。

而一个不经思考的问题，可能会让你遭到老师的蔑视（不过老师仍然会认可你敢于提问的态度），老师认为你浪费了他/她的时间，通常；老师会视你为懒惰的人`lazy man`。

很多学生只对如何做对题目拿到分数感兴趣，可能对于为什么和一些细节没有想法，数学就像语文英语等学科一样，是得分的工具，得到老师家长称赞奖励的必由之路。当然作为老师我们也不指望学生能像数学家或者学者一样每时每刻都在思考（有很多这类的故事，苯环，四元数的由来，阿基米德想到浮力定律或者你身边的某些大佬等等），所以你不必表现出很聪明或者很感兴趣来得到称赞，大部分老师能看看出你的水平，但是你仍然可以表现出机敏、有想法、善于观察、乐于主动参与解决问题，至少你要表现你努力思考的态度。否则我建议你找个专门回答你问题的人，而不是要求老师这样帮助你。

如果你决定向老师求助，当然你也不希望被视为失败者，更不愿成为失败者中的一员。能立刻得到快速并有效答案的最好方法，就是像赢家那样提问 —— 聪明、自信、有解决问题的思路，只是偶尔在特定的问题上需要获得一点帮助。
...
在你准备要通过电子邮件、新闻群组或者聊天室提出技术问题前，请先做到以下事情：
  ...
  1. 尝试在你以前的笔记和错题集中寻找答案并理解。
  2. 尝试上网搜索以找到答案并理解。
  3. 尝试在一些论坛或者老师请教答案并理解。
  4. 向你身边的大佬请教到答案并理解。
  5. 如果你还没找到解决方法不妨先放下来，过几天再沉浸思考。
  6. 在5的条件下，自己思考以找到答案并理解。

当你提出问题的时候，请先表明你已经做了上述的努力；这将有助于树立你并不是一个不劳而获且浪费别人的时间的提问者。如果你能一并表达在做了上述努力的过程中所**学到**的东西会更好，因为我们更乐于回答那些表现出能从答案中学习的人的问题。

运用某些策略，比如先用 Google/Bing/Ai 搜索你所遇到的各种错误信息，这样很可能直接就找到了能解决问题的文件或邮件列表线索。即使没有结果，在向别人寻求帮助时或者网络社区提问时加上一句 `我在 xxx 中搜过下列句子但没有找到什么有用的东西` 也是件好事，即使它只是表明了搜索引擎不能提供哪些帮助。这么做（加上搜索过的字串）也让遇到相似问题的其他人能被搜索引擎引导到你的提问来。

别着急，不要指望几秒钟的 xxx 搜索就能解决一个复杂的问题。在向专家求助之前，再思考一下问题（看看自己是不是遗漏）、放轻松、坐得舒服一些，再花点时间思考一下这个问题。相信我们，他们能从你的提问看出你做了多少阅读与思考，如果你是有备而来，将更有可能得到解答。不要将所有问题一股脑拋出，只因你的第一次搜索/思考没有找到答案（或者找到太多答案）。

准备好你的问题，再将问题仔细地思考过一遍，因为草率的发问只能得到草率的回答，或者根本得不到任何答案。越是能表现出在寻求帮助前你为解决问题所付出的努力，你越有可能得到实质性的帮助。

另一方面，表明你愿意在找答案的过程中做点什么是一个非常好的开端。`我有个思路？但是可能不对或者我做错了`、`我的这个例子里缺了什么？`以及`我应该检查什么地方`比`我的思路哪里有问题`更容易得到答复。因为你表现出只要有人能指个正确方向，你就有完成它的能力和决心。
